...
async function readMochaReport(reportPath, testEnvPath) {
	console.warn(reportPath) 
	...
	totalTests = testsResults.stats.tests

	const passedTests = testsResults.stats.passes
	const failedTests = testsResults.stats.failures
	const brokenTests = testsResults.stats.pending
	const skippedTests = testsResults.stats.failures
...
module.exports = { readMochaReport }
